...
---number 가변 숫자 타입으로 컬럼명 NUMBER(percison,scale)
---precision로 설정한 값은 전체자릿수, scale로 설정된 값은 소숫점 이하 자릿수
---생략하면 0이므로 정수
---price NUMBER
---price NUMBER(8,2)
...
select * from num;
insert into NUM
values (1234567.89,1234567.89,1234567.89,1234567.89,1234567.89,1234567.89,123456,0.00123);